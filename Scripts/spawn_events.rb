# Source: https://raw.githubusercontent.com/Archeia/YEARepo/master/Utility/Spawn_Event.rb
# Patched a bug with events.keys.max being nil! See GitHub for details (PR #2)
# Patched a bug with cloning (see PR #3)
